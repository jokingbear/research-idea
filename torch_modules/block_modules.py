...
class ConvolutionTModule(nn.Module):

    def __init__(self, fi, fo, kernel=2, strides=2, activation=True, normalization=None):
        super().__init__()
...
class ResidualModule(nn.Module):
    ...
    def __init__(self, n_group, fi, bottleneck, n_iter=3, down_sample=False, normalizations=(None, None, None)):
        ...
        self.con1 = ConvolutionModule(fi, bottleneck * n_group, kernel=1, normalization=normalizations[0])
        self.con2 = ConvolutionModule(bottleneck, bottleneck, n_group=n_group,
