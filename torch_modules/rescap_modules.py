...
class DownModule(nn.Module):
    ...
    def __init__(self, fi, bottleneck, n_group=32, n_iter=3):
        ...
        self.con2 = blocks.ConvolutionModule(2*fi, 2*fi, padding=1, normalization=get_normalization_layer(2*fi))
...
class UpModule(nn.Module):
    ...
    def __init__(self, fi, bottleneck, n_group=32, n_iter=3):
        ...
        self.cont1 = blocks.ConvolutionTModule(fi, fi//2, normalization=get_normalization_layer(fi//2))
        self.cont2 = blocks.ConvolutionModule(fi, fi//2, padding=1, normalization=get_normalization_layer(fi//2))
